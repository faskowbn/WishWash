        ...
        return (
          <div>
            ...
            {header}
              ...
              <RaisedButton label="raised button" className="raised-button" style={{align: 'center'}} label="Submit" style={{margine: 12, right: 0}} onTouchTap={this.handleSubmit.bind(this)} />
              </paper>
            </Card>
          </div>
        );
